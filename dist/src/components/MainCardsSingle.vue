...
<template>
  <div class="card" @click="selectClick">
...
.card{
    @apply cursor-pointer overflow-hidden rounded-md bg-slate-50 p-8 shadow-md hover:scale-125 transition-transform duration-300 hover:shadow-slate-900;
 &-image {
      img {
